Feature: Search games by manufacturer
  ...
  @gamesByDeveloper
  Scenario: Filter games that contain the developer Nintendo
   ...
   Scenario: Filter games by developer without finding result
      ...
      | Super Smash Bros. Ultimate | 2018         | Bandai Namco Studios | E      |
      | The Last of Us             | 2013         | Naughty Dog          | M      |
      Given the user enters the developer: Blizzar
      When the user search games by developer
      Then 0 games will match
      And the following message is displayed: No game developed by Blizzar found
